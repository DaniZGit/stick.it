<template>
  <div class="h-full flex flex-col">
    ...
    <div class="h-full grid grid-cols-12 bg-base-tertiary p-4">
      <div class="h-full col-span-9 flex justify-center gap-x-2">
        <div class="h-full aspect-thumbnail bg-base-white"></div>
          ...
          <div>
            <div class="bg-base-white rounded-md">
              <Icon
                ...
                size="42"
                class="border-2 border-transparent rounded-md hover:border-black hover:cursor-pointer hover:text-red-700"
              />
            </div>
          </div>
        </div>
